...
sudo /usr/sbin/grafana-cli --pluginUrl https://github.com/panodata/grafana-map-panel/releases/download/0.12.0/grafana-map-panel-0.12.0.zip plugins install grafana-map-panel
